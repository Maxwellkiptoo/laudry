...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($conn->query($delete_sql) === TRUE) {
            echo "<script>alert('Complaint deleted successfully.'); window.location.href='home.php';</script>";
        } else {
            echo "Error: " . $conn->error;
        }
    } else {
         echo "<script>alert('You can only delete your own complaints.'); window.location.href='home.php';</script>";
    }
} else {
